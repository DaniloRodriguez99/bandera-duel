...
const CLASS_SKILLS: Record<ClassId, SkillPreview[]> = {
  ...
  mage: [
    ...
    { name: 'Singularidad', icon: icon('mage-blackhole'), description: 'Apuntá y canalizá 2 s; el vórtice atrae enemigos, consume a quienes llegan al centro, crece durante 4 s y estalla.', damage: '1,5; letal en el centro', cooldown: seconds(RULES.blackHoleCooldown) },
  ],
  necromancer: [
