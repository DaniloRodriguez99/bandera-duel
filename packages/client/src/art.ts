...
// The necromancer zombie: tall wide-brimmed hat banded in the summoner's color (3),
// burning red eyes (9), bone teeth (6) and a torn cape over long arms.
export const HAT_ZOMBIE_ART: string[] = [
  '......0000......','......0330......','...0000000000...','....77979777....',
  '....77722777....','.....762267.....','..333333333333..','.73336262633337.',
  '.7.3362626333.7.','...333333333....','..33.33333.33...','..3..33.33..3...',
  '.....77..77.....','....77....77....','....88....88....','................',
];
export function hatPalette(cloth: string, light: string): Record<string,string> {
  return {...zombiePalette(cloth, light), 0:'#15101c', 2:'#1d241c', 6:'#d6cfb3', 7:'#7f9a6e', 9:'#ff4a3d'};
}
