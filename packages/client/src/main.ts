...
function showClassControls(id:ClassId) {
  ...
  if(id==='archer') $('control-guide').innerHTML += '<span><kbd>Q</kbd> Trampa · inmóvil 0,5 s</span><span><kbd>E</kbd> Triple flecha · 5 s</span><span><kbd>CARGANDO + E</kbd> Triple al 33 %</span><span><kbd>CLIC + ESPACIO AL MÁXIMO</kbd> Avanzando hacia el tiro: flecha de viento penetrante que rompe escudos (+E: triple de viento)</span>';
