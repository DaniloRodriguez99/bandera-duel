...
export class Controls {
  ...
  read(seq: number): Input {
    ...
    const result = { seq, x: x / n, y: y / n, angle: this.angle, ...this.actions, charge: this.chargeSources.size > 0, guard: this.guardSources.size > 0, aimX: this.aimX, aimY: this.aimY };
