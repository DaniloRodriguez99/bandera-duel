...
export const SKILLS_WORLD: Record<string, WorldSkill> = {
  ...
  // ─── One road per door: every affinity has something for a common birth and something rarer ───
  brisa: {
    id: 'brisa',
    name: 'Brisa',
    school: 'viento',
    rarity: 'comun',
    flavor: 'Nunca estuviste donde te buscan.',
    incantation: 'Viento, llevame un paso más allá…',
    color: '#d8fbff',
    icon: 'skill-brisa',
    mana: 3,
    cooldown: 4,
    effect: { kind: 'dash', distance: 110 },
    maxLevel: 12,
    firstLevelUses: 10,
    evolutions: [
      { level: 5, name: 'Ráfaga Veloz', line: 'El aire ya se abre antes de que lo pidas.' },
      { level: 9, name: 'Paso del Vendaval', line: 'Donde pisás, el pasto tarda en volver a pararse.' },
    ],
    tree: [node('brisa', 1, { name: 'Más Lejos', level: 3, cost: 1, text: 'El salto llega más lejos.', grants: { range: 40 } })],
  },
  guijarro: {
    id: 'guijarro',
    name: 'Guijarro',
    school: 'tierra',
    rarity: 'comun',
    flavor: 'La montaña empieza por una piedra.',
    incantation: 'Tierra, prestame lo que te sobra…',
    color: '#c9a36b',
    icon: 'skill-guijarro',
    mana: 3,
    cooldown: 1.4,
    effect: { kind: 'bolt', element: 'tierra', damage: 1, range: 320 },
    maxLevel: 12,
    firstLevelUses: 10,
    evolutions: [
      { level: 5, name: 'Lanza de Roca', line: 'Ya no tirás piedras: tirás el suelo.' },
      { level: 9, name: 'Meteoro', line: 'Algo cae del cielo, y lo trajiste vos.' },
    ],
    tree: [node('guijarro', 1, { name: 'Esquirlas', level: 4, cost: 2, text: 'Estalla al pegar.', grants: { radius: 50 } })],
  },
  chispazo: {
    id: 'chispazo',
    name: 'Centella',
    ...
    mana: 3,
    cooldown: 1,
    effect: { kind: 'bolt', element: 'rayo', damage: 0.8, range: 440 },
    maxLevel: 12,
    firstLevelUses: 10,
    evolutions: [
      { level: 5, name: 'Relámpago', line: 'Tu dedo apunta y el aire obedece.' },
      { level: 9, name: 'Rayo Encadenado', line: 'Un solo golpe ya no alcanza para que se detenga.' },
    ],
    tree: [node('chispazo', 1, { name: 'Conductor', level: 4, cost: 2, text: 'Atraviesa a todos en la línea.', grants: { pierce: true } })],
  },
  luz_tenue: {
    id: 'luz_tenue',
    name: 'Luz Tenue',
    school: 'luz',
    rarity: 'comun',
    flavor: 'Alcanza con no apagarse.',
    incantation: 'Que lo que brilla en mí alcance a los míos…',
    color: '#fff1a8',
    icon: 'skill-luz_tenue',
    mana: 5,
    cooldown: 5,
    effect: { kind: 'heal', amount: 1.5, radius: 130 },
    maxLevel: 12,
    firstLevelUses: 10,
    evolutions: [
      { level: 5, name: 'Luz Cálida', line: 'Los que están cerca tuyo respiran mejor.' },
      { level: 9, name: 'Aurora', line: 'Donde estás, amanece un poco.' },
    ],
    tree: [node('luz_tenue', 1, { name: 'Resplandor', level: 3, cost: 1, text: 'Cura a más distancia.', grants: { radius: 50 } })],
  },
  zarpa_sombria: {
    id: 'zarpa_sombria',
    name: 'Zarpa Sombría',
    ...
    mana: 3,
    cooldown: 1.4,
    effect: { kind: 'bolt', element: 'sombra', damage: 0.8, range: 260, drain: 0.3 },
    maxLevel: 12,
    firstLevelUses: 10,
    evolutions: [
      { level: 5, name: 'Garra del Vacío', line: 'Lo que tocás pierde un poco de ser.' },
      { level: 9, name: 'Fauces de la Noche', line: 'La oscuridad aprendió a masticar.' },
    ],
    tree: [node('zarpa_sombria', 1, { name: 'Hambre', level: 3, cost: 1, text: 'Roba más vida.', grants: { drain: 0.2 } })],
  },
  paso_sombrio: {
    id: 'paso_sombrio',
    name: 'Paso Sombrío',
    school: 'sigilo',
    rarity: 'comun',
    flavor: 'Estaba ahí. Ya no.',
    color: '#6fbf8a',
    icon: 'skill-paso_sombrio',
    mana: 3,
    cooldown: 5,
    effect: { kind: 'dash', distance: 90, invulnerable: true },
    maxLevel: 12,
    firstLevelUses: 10,
    evolutions: [
      { level: 5, name: 'Paso de Humo', line: 'Ni tu sombra sabe dónde vas a aparecer.' },
      { level: 9, name: 'Parpadeo', line: 'El mundo parpadea, y vos ya estás del otro lado.' },
    ],
    tree: [node('paso_sombrio', 1, { name: 'Sin Huella', level: 3, cost: 1, text: 'Se recarga antes.', grants: { cooldown: -0.25 } })],
  },
  estocada: {
    id: 'estocada',
    name: 'Estocada',
    school: 'destreza',
    rarity: 'comun',
    flavor: 'Una línea recta es la distancia más corta hasta el corazón.',
    color: '#8fe3b0',
    icon: 'skill-estocada',
    mana: 2,
    cooldown: 0.9,
    effect: { kind: 'bolt', element: 'fisico', damage: 1.2, range: 150 },
    maxLevel: 12,
    firstLevelUses: 10,
    evolutions: [
      { level: 5, name: 'Estocada Doble', line: 'Tu brazo ya golpeó dos veces antes de que lo vieran moverse.' },
      { level: 9, name: 'Aguijón', line: 'Una herida pequeña que no se cierra.' },
    ],
    tree: [node('estocada', 1, { name: 'Alcance', level: 3, cost: 1, text: 'Llega más lejos.', grants: { range: 60 } })],
  },
  bola_fuego: {
    id: 'bola_fuego',
    name: 'Bola de Fuego',
    school: 'fuego',
    rarity: 'rara',
    flavor: 'Lo que no se quema, se aparta.',
    incantation: 'Llama que duerme en el pecho, despertá y rodá…',
    color: '#ff7a2f',
    icon: 'skill-bola_fuego',
    mana: 8,
    cooldown: 3,
    effect: { kind: 'bolt', element: 'fuego', damage: 2, range: 360, explode: 60 },
    maxLevel: 10,
    firstLevelUses: 14,
    evolutions: [{ level: 6, name: 'Sol Menor', line: 'Por un segundo, hay dos soles.' }],
    tree: [node('bola_fuego', 1, { name: 'Estallido Amplio', level: 3, cost: 2, text: 'Explota más grande.', grants: { radius: 40 } })],
  },
  descarga: {
    id: 'descarga',
    name: 'Descarga',
    ...
    mana: 7,
    cooldown: 2.5,
    effect: { kind: 'bolt', element: 'rayo', damage: 1.4, range: 480, pierce: true },
    maxLevel: 10,
    firstLevelUses: 14,
    evolutions: [{ level: 6, name: 'Lanza del Cielo', line: 'El aire huele a quemado mucho después.' }],
    tree: [],
  },
  destello: {
    id: 'destello',
    ...
    school: 'luz',
    rarity: 'rara',
    flavor: 'Mirarte de frente tiene un precio.',
    incantation: 'Que la luz se vea de golpe…',
    color: '#fff1a8',
    icon: 'skill-destello',
    mana: 7,
    cooldown: 6,
    effect: { kind: 'nova', element: 'luz', damage: 0.8, radius: 110, freeze: 0.8 },
    maxLevel: 10,
    firstLevelUses: 14,
    evolutions: [{ level: 6, name: 'Sol en la Mano', line: 'Los que te rodean ven blanco un rato.' }],
    tree: [],
  },
  danza_filos: {
    id: 'danza_filos',
    ...
    school: 'destreza',
    rarity: 'rara',
    flavor: 'No es un ataque. Es un baile en el que todos pierden menos vos.',
    color: '#8fe3b0',
    icon: 'skill-danza_filos',
    mana: 6,
    cooldown: 5,
    effect: { kind: 'nova', element: 'fisico', damage: 1.5, radius: 90 },
    maxLevel: 10,
    firstLevelUses: 14,
    evolutions: [{ level: 6, name: 'Remolino de Acero', line: 'El acero gira más rápido que la vista.' }],
    tree: [],
  },
  furia: {
    id: 'furia',
    ...
    school: 'fuerza',
    rarity: 'rara',
    flavor: 'Pensar viene después.',
    color: '#e0a060',
    icon: 'skill-furia',
    mana: 7,
    cooldown: 14,
    effect: { kind: 'buff', damage: 0.5, speed: 0.1, duration: 4 },
    maxLevel: 10,
    firstLevelUses: 14,
    evolutions: [{ level: 6, name: 'Sangre Hirviente', line: 'Te duele menos de lo que debería.' }],
    tree: [],
  },
  lluvia_brasas: {
    id: 'lluvia_brasas',
    ...
    school: 'fuego',
    rarity: 'epica',
    flavor: 'El cielo también puede arder.',
    incantation: 'Que llueva lo que quema, alrededor, sin elegir…',
    color: '#ff7a2f',
  ...
  marea: {
    ...
    school: 'agua',
    rarity: 'epica',
    flavor: 'Todo vuelve, si sabés esperar.',
    incantation: 'Agua que sube y baja, subí por nosotros…',
    color: '#7dd8ff',
    icon: 'skill-marea',
    mana: 14,
    cooldown: 10,
    effect: { kind: 'heal', amount: 4, radius: 170 },
    maxLevel: 8,
    firstLevelUses: 20,
    evolutions: [{ level: 5, name: 'Pleamar', line: 'Las heridas cierran como si nunca hubieran estado.' }],
    tree: [],
  },
  vendaval: {
    id: 'vendaval',
    ...
    school: 'viento',
    rarity: 'epica',
    flavor: 'El viento no empuja: decide dónde estás.',
    incantation: 'Que todo gire alrededor mío…',
    color: '#d8fbff',
    icon: 'skill-vendaval',
    mana: 13,
    cooldown: 8,
    effect: { kind: 'nova', element: 'viento', damage: 2, radius: 150, freeze: 0.4 },
    maxLevel: 8,
    firstLevelUses: 20,
    evolutions: [{ level: 5, name: 'Ojo del Huracán', line: 'Solo vos estás quieto.' }],
    tree: [],
  },
  terremoto: {
    id: 'terremoto',
    ...
    school: 'tierra',
    rarity: 'epica',
    flavor: 'La tierra no se mueve seguido. Cuando lo hace, se acuerdan.',
    incantation: 'Montaña, despertate un momento…',
    color: '#c9a36b',
    icon: 'skill-terremoto',
    mana: 14,
    cooldown: 10,
    effect: { kind: 'nova', element: 'tierra', damage: 2.5, radius: 160, freeze: 0.8 },
    maxLevel: 8,
    firstLevelUses: 20,
    evolutions: [{ level: 5, name: 'Falla', line: 'Queda una grieta donde golpeaste.' }],
    tree: [],
  },
  mil_sombras: {
    id: 'mil_sombras',
    ...
    school: 'sigilo',
    rarity: 'epica',
    flavor: 'Te van a buscar en todas partes menos donde estás.',
    color: '#6fbf8a',
    icon: 'skill-mil_sombras',
    mana: 11,
    cooldown: 12,
    effect: { kind: 'buff', damage: 1, speed: 0.35, duration: 3 },
    maxLevel: 8,
    firstLevelUses: 20,
    evolutions: [{ level: 5, name: 'Nadie', line: 'Ni siquiera tu nombre deja huella.' }],
    tree: [],
  },
  contraataque: {
    id: 'contraataque',
    ...
    school: 'destreza',
    rarity: 'epica',
    flavor: 'Tu mejor golpe es el suyo.',
    color: '#8fe3b0',
    icon: 'skill-contraataque',
    mana: 5,
    cooldown: 4,
    effect: { kind: 'parry', window: 0.5, reflect: 2 },
    maxLevel: 8,
    firstLevelUses: 20,
    evolutions: [{ level: 5, name: 'Espejo de Acero', line: 'Lo que te tiran vuelve el doble de rápido.' }],
    tree: [],
  },
  golpe_titanico: {
    id: 'golpe_titanico',
    ...
    school: 'fuerza',
    rarity: 'epica',
    flavor: 'Un golpe. El resto es polvo.',
    color: '#e0a060',
    icon: 'skill-golpe_titanico',
    mana: 10,
    cooldown: 7,
    effect: { kind: 'nova', element: 'fisico', damage: 3.5, radius: 80 },
    maxLevel: 8,
    firstLevelUses: 20,
    evolutions: [{ level: 5, name: 'Puño de la Montaña', line: 'El suelo se hunde donde caés.' }],
    tree: [],
  },
  sol_caido: {
    id: 'sol_caido',
    ...
    school: 'fuego',
    rarity: 'legendaria',
    flavor: 'Alguien tuvo que bajarlo.',
    incantation: 'Sol que mirás desde lejos, vení a mirar de cerca…',
    color: '#ff7a2f',
    icon: 'skill-sol_caido',
    mana: 24,
    cooldown: 20,
    effect: { kind: 'nova', element: 'fuego', damage: 5, radius: 200 },
    maxLevel: 6,
    firstLevelUses: 30,
    evolutions: [{ level: 4, name: 'Amanecer Rojo', line: 'El horizonte se enciende de tu lado.' }],
    tree: [],
  },
  tormenta_eterna: {
    id: 'tormenta_eterna',
    ...
    mana: 22,
    cooldown: 18,
    effect: { kind: 'nova', element: 'rayo', damage: 4, radius: 180, freeze: 0.6 },
    maxLevel: 6,
    firstLevelUses: 30,
    evolutions: [{ level: 4, name: 'Cielo Roto', line: 'Donde vas, llueve luz.' }],
    tree: [],
  },
  abrazo_abismo: {
    id: 'abrazo_abismo',
    name: 'Abrazo del Abismo',
    school: 'sombra',
    rarity: 'legendaria',
    ...
    mana: 20,
    cooldown: 12,
    effect: { kind: 'bolt', element: 'sombra', damage: 4, range: 420, drain: 0.8, pierce: true },
    maxLevel: 6,
    firstLevelUses: 30,
    evolutions: [{ level: 4, name: 'Noche sin Fondo', line: 'Lo que entra ya no sale.' }],
    tree: [],
  },
  juicio_celestial: {
    id: 'juicio_celestial',
    ...
    school: 'luz',
    rarity: 'legendaria',
    flavor: 'La luz también sabe ser un muro que cae.',
    incantation: 'Que todo lo que no deba estar acá, se vaya…',
    color: '#fff1a8',
    icon: 'skill-juicio_celestial',
    mana: 22,
    cooldown: 18,
    effect: { kind: 'nova', element: 'luz', damage: 4, radius: 170 },
    maxLevel: 6,
    firstLevelUses: 30,
    evolutions: [{ level: 4, name: 'Cielo Abierto', line: 'Por un momento, todos ven lo que vos ves.' }],
    tree: [],
  },
  ...
  pedrada: {
    id: 'pedrada', name: 'Pedrada', school: 'monstruo', rarity: 'rara',
    flavor: 'Una piedra bien tirada vale más que una espada mal usada.',
    color: '#b8a672', icon: 'skill-pedrada', mana: 2, cooldown: 1.6,
    effect: { kind: 'bolt', element: 'tierra', damage: 0.9, range: 320 },
    maxLevel: 6, firstLevelUses: 8,
    evolutions: [{ level: 4, name: 'Lluvia de Piedras', line: 'Ya no tirás una: tirás un puñado.' }],
    tree: [],
  },
  raices_ent: {
    id: 'raices_ent', name: 'Raíces', school: 'monstruo', rarity: 'rara',
    flavor: 'El suelo también tiene manos.',
    color: '#6fbf5a', icon: 'skill-raices_ent', mana: 8, cooldown: 9,
    effect: { kind: 'nova', element: 'tierra', damage: 0.8, radius: 120, freeze: 1.2 },
    maxLevel: 6, firstLevelUses: 8,
    evolutions: [{ level: 4, name: 'Bosque Vivo', line: 'Las raíces ya te obedecen antes de que las llames.' }],
    tree: [],
  },
  brasa_viva: {
    id: 'brasa_viva', name: 'Brasa Viva', school: 'monstruo', rarity: 'rara',
    flavor: 'Arde porque todavía no terminó de quemar.',
    color: '#ff8a3a', icon: 'skill-brasa_viva', mana: 5, cooldown: 2.4,
    effect: { kind: 'bolt', element: 'fuego', damage: 1.2, range: 380, explode: 40 },
    maxLevel: 6, firstLevelUses: 8,
    evolutions: [{ level: 4, name: 'Corazón del Incendio', line: 'Donde pisás, queda ceniza.' }],
    tree: [],
  },
  escupitajo: {
    id: 'escupitajo', name: 'Escupitajo', school: 'monstruo', rarity: 'rara',
    flavor: 'Asqueroso. Efectivo.',
    color: '#b6e05a', icon: 'skill-escupitajo', mana: 4, cooldown: 3,
    effect: { kind: 'bolt', element: 'sombra', damage: 0.6, range: 300, drain: 0.3 },
    maxLevel: 6, firstLevelUses: 8,
    evolutions: [{ level: 4, name: 'Bilis Pálida', line: 'Lo que tocás se pudre un poco.' }],
    tree: [],
  },
  golpe_oseo: {
    id: 'golpe_oseo', name: 'Golpe Óseo', school: 'monstruo', rarity: 'rara',
    flavor: 'No siente dolor. No tiene con qué.',
    color: '#e8e0c8', icon: 'skill-golpe_oseo', mana: 4, cooldown: 4,
    effect: { kind: 'nova', element: 'fisico', damage: 1.4, radius: 70 },
    maxLevel: 6, firstLevelUses: 8,
    evolutions: [{ level: 4, name: 'Danza de Huesos', line: 'Cada golpe suena como un tambor.' }],
    tree: [],
  },
  dardo_sombrio: {
...
export const MONSTER_TREES: Record<MobFamilyId, { passive: Passive; skills: string[] }> = {
  ...
  duende: {
    passive: { id: 'dedos_ligeros', name: 'Dedos Ligeros', text: 'Aprendés un poco más de todo lo que matás.', xp: 0.1 },
    skills: ['pedrada'],
  },
  ent: {
    passive: { id: 'corteza', name: 'Corteza', text: 'Mucha más vida máxima.', maxHp: 0.18 },
    skills: ['raices_ent'],
  },
  espiritu_ceniza: {
    passive: { id: 'corazon_brasa', name: 'Corazón de Brasa', text: 'Tus golpes queman un poco más.', damage: 0.08 },
    skills: ['brasa_viva'],
  },
  sapo: {
    passive: { id: 'piel_viscosa', name: 'Piel Viscosa', text: 'Te regenerás de a poco.', regen: 0.15 },
    skills: ['escupitajo'],
  },
  esqueleto: {
    passive: { id: 'huesos_huecos', name: 'Huesos Huecos', text: 'Te movés más liviano.', speed: 0.06 },
    skills: ['golpe_oseo'],
  },
  nigromante: {
    passive: { id: 'pacto_pantano', name: 'Pacto del Pantano', text: 'Más daño y algo de regeneración.', damage: 0.05, regen: 0.1 },
    skills: ['dardo_sombrio'],
  },
};
...
/** The doors each weapon leans towards. A staff opens every arcane one a little. */
const WEAPON_SCHOOLS: Record<string, SkillSchool[]> = {
  espada: ['fuerza', 'destreza', 'cuerpo'],
  baston: ['fuego', 'agua', 'tierra', 'viento', 'rayo', 'sombra', 'luz'],
  arco: ['viento', 'destreza', 'rayo'],
  daga: ['sigilo', 'destreza', 'sombra'],
  escudo: ['fuerza', 'tierra', 'luz', 'cuerpo'],
};

/** What was placed at birth, as far as fate is concerned. */
...
export function destinyWeight(skill: WorldSkill, choice?: DestinyChoice) {
  ...
  if (weapon.includes(skill.school)) weight += sparks > 0 ? 2 : 1;
  if (skill.school === 'cuerpo') weight += 0.5;
  return weight;
}
...
export function rollDestiny(random: () => number, choice?: DestinyChoice): { skillId: string; rarity: Rarity } {
  ...
  for (let i = 0; i < pool.length; i++) {
    roll -= weights[i];
    if (roll < 0) return { skillId: pool[i], rarity };
  }
  return { skillId: pool[pool.length - 1], rarity };
}
...
/** What each door is for, in one line: shown at birth and in the System. */
export const AFFINITY_TEXT: Record<Affinity, string> = {
  fuego: 'El daño más alto del juego, y en área.',
  agua: 'La única que cura de verdad. También congela.',
  tierra: 'Aguanta, rompe guardias y hace temblar el suelo.',
  viento: 'Movilidad y golpes que atraviesan. Algún día, volar.',
  rayo: 'Instantáneo: lo que no viaja no se esquiva.',
  sombra: 'Roba vida y levanta a los muertos.',
  luz: 'Protege y cura a otros; castiga a los no-muertos.',
  fuerza: 'El golpe cuerpo a cuerpo más fuerte y más aguante.',
  destreza: 'Ataca más seguido, esquiva y para mejor que nadie.',
