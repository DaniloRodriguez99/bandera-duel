...
export const SKILLS_WORLD: Record<string, WorldSkill> = {
  ...
  pedrada: {
    ...
    color: '#b8a672', icon: 'guardian-bash', mana: 2, cooldown: 1.6,
  ...
  raices_ent: {
    ...
    color: '#6fbf5a', icon: 'mage-ice', mana: 8, cooldown: 9,
  ...
  brasa_viva: {
    ...
    color: '#ff8a3a', icon: 'necromancer-fire', mana: 5, cooldown: 2.4,
  ...
  escupitajo: {
    ...
    color: '#b6e05a', icon: 'archer-wind', mana: 4, cooldown: 3,
  ...
  golpe_oseo: {
    ...
    color: '#e8e0c8', icon: 'vanguard-slash', mana: 4, cooldown: 4,
  ...
  dardo_sombrio: {
    ...
    color: '#a070e0', icon: 'necromancer-summon', mana: 6, cooldown: 2.8,
