...
El mago también lanza un proyectil de hielo con clic central (presionar la rueda, botón 3) o el botón táctil ❄. Inmoviliza al objetivo durante 0,5 segundos, sin daño adicional, y tiene 3 segundos de recarga independiente del fuego. Bloquea caminar y dash, pero permite apuntar y atacar. Los escudos y la invulnerabilidad bloquean el efecto.
